...
for fold_number, (train_idx, test_idx) in enumerate(kf.split(new_df), 1):
    ...
    lreg = LogisticRegression(max_iter=500, C=0.01, random_state=2020)
    ...
    svc = SVC(C=0.1,probability=True, random_state=2020)
    ...
    rfc = RandomForestClassifier(random_state=2020, n_estimators=30)
    ...
    xgb = XGBClassifier(min_child_weight=10,random_state=2020)
