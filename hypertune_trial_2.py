...
# Initializing backbone (frozen) + decoder layers for binary classification & setting other parameters
n_classes = 2
...
# defining the loss function & optimizer (decoder only)
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(decoder.parameters(), lr=1e-4)



# training the decoder layer only (backbone frozen) & predicting classes of test sequences over 10-folds
...
for fold, (train_idx, test_idx) in enumerate(kf.split(sequences, labels), 1):
    ...
    # training our decoder layer in batches
    epochs = 5
